...
final class EDDBackend extends AbstractWpdbBackend
{
     ...
     */
    /**
     * Actual edd_subscriptions columns (verified against DB schema):
     * id, customer_id, period, initial_amount, initial_tax_rate, initial_tax,
     * recurring_amount, recurring_tax_rate, recurring_tax, bill_times,
     * transaction_id, parent_payment_id, product_id, price_id, created,
     * date_modified, expiration, trial_period, status, profile_id, gateway.
     */
    ...
    private function describeSubscriptionFields(array $allOps): array
    {
        return [
            ...
            new FieldSchema('end_date', 'Expiration Date', ColumnType::Datetime, $allOps, timezone: 'utc'),
            new FieldSchema('initial_amount', 'Initial Amount', ColumnType::Float, $allOps, aggregatable: true),
            new FieldSchema('initial_tax', 'Initial Tax', ColumnType::Float, $allOps, aggregatable: true),
            new FieldSchema('recurring_amount', 'Recurring Amount', ColumnType::Float, $allOps, aggregatable: true),
            new FieldSchema('recurring_tax', 'Recurring Tax', ColumnType::Float, $allOps, aggregatable: true),
            ...
            new FieldSchema('date_created', 'Date Created', ColumnType::Datetime, $allOps,
                aggregatable: true, timezone: 'utc',
                description: 'Alias for created column.',
            ),
            new FieldSchema('date_modified', 'Date Modified', ColumnType::Datetime, $allOps,
                timezone: 'utc',
            ),
            // Semantic aliases.
            new FieldSchema('created_at', 'Created At', ColumnType::Datetime, $allOps,
            ...
            new FieldSchema('updated_at', 'Updated At', ColumnType::Datetime, $allOps,
                timezone: 'utc',
                description: 'Alias for date_modified column.',
            ),
        ];
    }
}
